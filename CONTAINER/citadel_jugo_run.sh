...
IMAGE_NAME="localhost/citadel-jugo:latest"
CONTAINER_NAME="citadel-jugo"
HOST_NAME="citadel-jugo"
...
ENV_FILE="${ENV_FILE:-${SCRIPT_DIR}/citadel_jugo.env}"
INJECT_ENV_FILE="${INJECT_ENV_FILE:-${SCRIPT_DIR}/citadel_jugo.inject.env}"
ENV_ARGS=()
if [[ -f "${ENV_FILE}" ]]; then
